...
class CustomerTest {
    ...
    void serviceTest() throws Exception {
        ...
        customer.setService(serviceBack);
        assertThat(customer.getService()).isEqualTo(serviceBack);
        assertThat(serviceBack.getCustomer()).isEqualTo(customer);

        customer.service(null);
        assertThat(customer.getService()).isNull();
        assertThat(serviceBack.getCustomer()).isNull();
    }
}
