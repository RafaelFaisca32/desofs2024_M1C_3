...
public interface LocationService {
    ...
    /**
     * Get all the LocationDTO where Service is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<LocationDTO> findAllWhereServiceIsNull();
    /**
     * Get all the LocationDTO where Transport is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<LocationDTO> findAllWhereTransportIsNull();
