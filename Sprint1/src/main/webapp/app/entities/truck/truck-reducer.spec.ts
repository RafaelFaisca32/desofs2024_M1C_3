...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './truck.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRUCK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRUCK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRUCK actions', async () => {
    ...
    it('dispatches UPDATE_TRUCK actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_TRUCK actions', async () => {
    ...
    it('dispatches DELETE_TRUCK actions', async () => {
      const arg = 42666;
