...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRIVER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRIVER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_DRIVER actions', async () => {
    ...
    it('dispatches DELETE_DRIVER actions', async () => {
      const arg = 42666;
