...
public class AdminUserDTO implements Serializable {
    ...
    public AdminUserDTO(User user) {
        ...
        this.firstName = user.getFirstName().getFirstName();
        this.lastName = user.getLastName().getLastName();
        this.email = user.getEmail().getEmail();
        this.activated = user.isActivated().getActivated();
        this.imageUrl = user.getImageUrl().getImageUrl();
        this.langKey = user.getLangKey().getLangKey();
