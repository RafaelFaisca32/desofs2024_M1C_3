...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './manager.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANAGER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MANAGER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MANAGER actions', async () => {
    ...
    it('dispatches UPDATE_MANAGER actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_MANAGER actions', async () => {
    ...
    it('dispatches DELETE_MANAGER actions', async () => {
      const arg = 42666;
