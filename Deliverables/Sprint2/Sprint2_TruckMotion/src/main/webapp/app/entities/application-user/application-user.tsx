                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {applicationUser.birthDate ? (
                      <TextFormat type="date" value={applicationUser.birthDate} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/application-user/${applicationUser.id}/delete`)}
                        color="danger"
                        size="sm"
