...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPLICATIONUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPLICATIONUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPLICATIONUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPLICATIONUSER actions', async () => {
      const arg = 42666;
