...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICESTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICESTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICESTATUS actions', async () => {
    ...
    it('dispatches UPDATE_SERVICESTATUS actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICESTATUS actions', async () => {
    ...
    it('dispatches DELETE_SERVICESTATUS actions', async () => {
      const arg = 42666;
