...
import { getEntity, deleteEntity } from './transport.reducer';
...
export const TransportDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truckMotionApp.transport.delete.question">Are you sure you want to delete Transport {transportEntity.id}?</ModalBody>
      <ModalFooter>
