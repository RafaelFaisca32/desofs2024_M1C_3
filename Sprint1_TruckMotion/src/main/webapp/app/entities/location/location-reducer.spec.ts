...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './location.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATION actions', async () => {
    ...
    it('dispatches UPDATE_LOCATION actions', async () => {
      const arg = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATION actions', async () => {
    ...
    it('dispatches DELETE_LOCATION actions', async () => {
      const arg = 42666;
