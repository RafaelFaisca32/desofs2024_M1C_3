package com.mycompany.myapp.application.controller.errors;

import static org.springframework.core.annotation.AnnotatedElementUtils.findMergedAnnotation;

import com.mycompany.myapp.domain.user.UsernameAlreadyUsedException;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        if (
            ex instanceof com.mycompany.myapp.domain.user.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof com.mycompany.myapp.domain.user.InvalidPasswordException
